            ...
            <div className="w-full bg-white mb-14">
              ...
              <div className="p-10">
                ...
                <table className="table-detail text-xs md:text-base">
                  <tr>
                    <td>Jumlah Cucian (Pcs)</td>
                    <td>Harga Paket Per/Pcs</td>
        ...
        <div className="flex justify-end py-8 px-10">
          <table className="table-payment text-xs md:text-base">
            ...
            <tr>
              ...
              {/* <td className="text-right">{'Rp' + laundryData?.ongkir.toLocaleString('id-ID')} </td> */}
            ...
            <tr>
              ...
              <td className="text-right">Rp1.000</td>
            </tr>
            <tr>
...
export default DetailPesananSatuan;
